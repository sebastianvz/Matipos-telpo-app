...
public class ConfigUtil {
    ...
    private static final int MATIPOS_SECONDS_ENABLE_LED = 3;
    ...
    private static boolean commitInt(Context context, @StringRes int keyRes, int newValue) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.edit().putInt(context.getString(keyRes), newValue).commit();
    }
    ...
    private static boolean commitString(Context context, @StringRes int keyRes, String newValue) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.edit().putString(context.getString(keyRes), newValue).commit();
    }
    ...
    public static boolean setTrackedFaceCount(Context context, int trackedFaceCount) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.edit().putInt(context.getString(R.string.preference_track_face_count), trackedFaceCount).commit();
    }
...
//        return getBoolean(context, R.string.preference_recognize_keep_max_face, false);
    ...
    public static float getImageQualityNoMaskRecognizeThreshold(Context context) {
        return Float.parseFloat(getString(context, R.string.preference_image_quality_no_mask_recognize_threshold, String.valueOf(IMAGE_QUALITY_NO_MASK_RECOGNIZE_THRESHOLD)));
    }

    public static float getImageQualityNoMaskRegisterThreshold(Context context) {
        return Float.parseFloat(getString(context, R.string.preference_image_quality_no_mask_register_threshold, String.valueOf(IMAGE_QUALITY_NO_MASK_REGISTER_THRESHOLD)));
    }

    public static float getImageQualityMaskRecognizeThreshold(Context context) {
        return Float.parseFloat(getString(context, R.string.preference_image_quality_mask_recognize_threshold, String.valueOf(IMAGE_QUALITY_MASK_RECOGNIZE_THRESHOLD)));
    }
    ...
    // Matipos
    public static String getMatiposUrlServer(Context context) {
        return getString(context, R.string.preference_matipos_url_server, MATIPOS_URL_SERVER);
    }

    public static boolean setMatiposUrlServer(Context context, String urlServer) {
        return commitString(context, R.string.preference_matipos_url_server, urlServer);
    }

    public static String getMatiposDeviceCode(Context context) {
        return getString(context, R.string.preference_matipos_device_code, MATIPOS_DEVICE_CODE);
    }

    public static boolean setMatiposDeviceCode(Context context, String deviceCode) {
        return commitString(context, R.string.preference_matipos_device_code, deviceCode);
    }

    public static boolean isMatiposIsNfcReaderEnable(Context context) {
    ...
    public static boolean setNfcReader(Context context, boolean state) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.edit().putBoolean(context.getString(R.string.preference_matipos_is_nfc_reader_enable), state).commit();
    }

    public static boolean isMatiposIsQrReaderEnable(Context context) {
        return getBoolean(context, R.string.preference_matipos_is_qr_reader_enable, MATIPOS_IS_QR_READER_ENABLE);
    }

    public static boolean setQrReader(Context context, boolean state) {
        if (context == null) {
            return false;
        }
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.edit().putBoolean(context.getString(R.string.preference_matipos_is_qr_reader_enable), state).commit();
    }

    public static int getMatiposSecondsEnableLed(Context context) {
        return getInt(context, R.string.preference_matipos_seconds_enable_led, MATIPOS_SECONDS_ENABLE_LED);
    }

    public static boolean setMatiposSecondsEnableLed(Context context, int seconds) {
        return commitInt(context, R.string.preference_matipos_seconds_enable_led, seconds);
    }
